...
bool Adafruit_LSM9DS1::begin()
{
  ...
  */
  ...
  //write8(XGTYPE, LSM9DS1_REGISTER_CTRL_REG1_G, 0x60); // on XYZ @ 200hz
  ...
  //write8(XGTYPE, LSM9DS1_REGISTER_CTRL_REG6_XL, 0x60);
  write8(XGTYPE, LSM9DS1_REGISTER_CTRL_REG7_XL, 0xA0); // Turn on HP mode, activate LPF with cutoff ODR/100
  //write8(XGTYPE, LSM9DS1_REGISTER_CTRL_REG7_XL, 0x50);
